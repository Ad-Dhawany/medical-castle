...
$pageTitle = "HOME";
$dir = "../";
if (!isset($_SESSION['username'], $_SESSION['userID'], $_SESSION['groupID']) || $_SESSION['groupID'] < 0 || $_SESSION['groupID'] > 3) {
    header("location: ../");
    exit();
}
...
?>
<script>
var pageTitle = "<?php echo lang("HOME") ?>";
</script>
<?php /** start verification page */
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption top-50 opacity-75 text-start">
                        <h1>A variety of medicines from the best international brands at competitive prices.</h1>
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption top-50 opacity-75">
                        <h1>We offer a variety of medical supplies.</h1>
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption top-50 opacity-75 text-end">
                        <h1>We provide the most requested skin care products.</h1>
...
<main class="my-5">
    <section class="brief-about-company container my-2">
        <h3 class="company-name"><b>Medical Castle Company</b></h3>
    ...
    <section class="container marketing my-2">
        ...
        <div class="row text-center">
            <div class="col-lg-4">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet corporis, unde quasi excepturi nemo temporibus voluptate quod tenetur libero accusamus.</p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <i class="fas fa-tag fs-1"></i>
                <h3>Best Offers</h3>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quod hic necessitatibus nobis voluptatibus obcaecati saepe fuga incidunt alias porro totam?</p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <i class="far fa-credit-card fs-1"></i>
                <h3>Online Payments</h3>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsam vitae accusantium, dicta dignissimos voluptatem quia possimus quidem optio adipisci eligendi!</p>
            </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
    </section>
</main>
