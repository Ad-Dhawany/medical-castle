...
if(isset($_SESSION['userID'], $_SESSION['regStatus']) && $_SESSION['regStatus'] > 0 && $_SESSION['groupID'] > 0){
    ...
    if(isset($_POST['orderID']) && is_numeric($_POST['orderID'])){
        ...
        ?>
            <section id="additinal-<?php echo $versionName ?>-version" data-additional="2" class="order-items-section my-4" style="display: none;">
                <div class="card">
                            ...
                            <table class="main-table items-table table table-bordered mb-0 text-center">
                                ...
                                <tfoot class="info-items-tfoot">
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><?php echo ($orderVersion === 1)? lang("TOTAL"). " : " : lang("TOTAL"). " : " ?> </td>
                                        <td <?php echo ($orderVersion === 1)? " title='". lang("DISCOUNT"). " = ". $discountValue. " ". lang("L.D"). "' ><span id='order-real-total'>". number_format($orderInfo->total, 2). "</span> ". lang("L.D") : "> <span id='order-total'>". $orderInfo->total. "</span> ". lang("L.D") ?> </td>
                                        <td><?php echo ($orderVersion === 1)? lang("AFT DIS"). " : " : "" ?></td>
                                        <td <?php echo ($orderVersion === 1)? " title='". lang("DISCOUNT"). " = ". $discountValue. " ". lang("L.D"). "' ><span id='order-real-total-net'>". number_format($orderInfo->totalNet, 2). "</span> ". lang("L.D") : ">" ?> </td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
    ...
    echo "error: 7104, Operation Faild";
}
echo "error: 7106, Operation Faild";
exit();