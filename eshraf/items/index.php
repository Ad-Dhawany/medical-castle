...
ob_start();
    ...
    if(!isset($_SESSION['username']) || !isset($_SESSION['userID'])){
        ...
        if($do == 'manage'){
            //Start Manage page
            $items = stat_getObjects::getItems("visibility > -1 ORDER BY itemID DESC LIMIT 50");
         ...
         ?>
            <main class="main-items-container overflow-hidden p-2" data-body-width="540px">
                <div class="row m-2">
                    ...
                    <section class="col-10 offset-1 my-3 p-3 form-container-ver1">
                        <div class="me-3">
                            ...
                            <div class="col-9 offset-3 col-sm-8 offset-sm-4 col-md-5 offset-md-7 my-2 my-md-1 d-inline-flex justify-content-between mb-2 add-items">
                                <a href="./?do=csvupload" class="btn btn-primary col-6 mx-1"><i class="fas fa-file-import"></i> <?php echo langs("IMP ITE") ?></a>
                                <a href="./?do=add" class="btn btn-primary col-6 mx-1"><i class="far fa-file-lines"></i> <?php echo lang("NEW ITE") ?></a>
                            </div>
                            <hr>
                        </div>
                            ...
                            <div class="d-flex">
                                <div class="form-group form-group-lg col-5 m-1">
                                    ...
                                    <div class="input-field col-11">
                                        <input id="search-by-num" type="text" name="" class="form-control search-input <?php echo (!is_array($items))? "point-none" : "" ?>" placeholder="">
                                    </div>
                                ...
                                <div class="form-group form-group-lg col-7 m-1">
                                    ...
                                    <div class="input-field col-11">
                                        <input id="search-by-name" type="text" name="" class="form-control search-input <?php echo (!is_array($items))? "point-none" : "" ?>" placeholder="">
                                    </div>
                   ...
                   <?php if(is_array($items)){ ?>
                    <section class="items-section" style="min-width: 540px;">
                        <div class="card">
                            <div class="card-header pb-0">
                                <section class="col-12 d-flex flex-wrap p-2">
                                <!-- <div class="col-6"> -->
                                    <span class="p-2 col-4 col-md-3 col-lg-2">
                                ...
                                <section class="w-100 px-2">
                                    ...
                                    <label for="items-order-by" class="">Order By: </label>
                                        <select class="form-select d-inline-block w-auto" id="items-order-by">
                                            <option class="items-order-by-opt" value="name">Name</option>
                                            <option class="items-order-by-opt" value="add" selected>Adding Date</option>
                                            <option class="items-order-by-opt" value="pay">Last Purchase Price</option>
                                            <option class="items-order-by-opt" value="sale">Sale Price</option>
                                            <option class="items-order-by-opt" value="qty">Quantity</option>
                                            <option class="items-order-by-opt" value="exp">Exp Date</option>
                                        </select>
                            ...
                            <div class="card-body p-0">
                                ...
                                <nav class="mt-2" aria-label="items table pagination">
                ...
                <div class="row">
                    <div class="col-10 offset-1 p-4 form-container-ver1">
                        <form class = "csv-upload" method="POST" enctype="multipart/form-data" action="./?do=csvmapping">
                            ...
                            <div class="form-label visibility-switcher" data-visibility='switcher' data-vis-Id="importing-setting">
        ...
        <?php
            ...
            $delimiter = (in_array($_POST['delimiter'], [";",";;",",",",,","  ","   "," ",".",".."])) ? $_POST['delimiter'] : fnc::redirectHome("invalid Delimiter",'back',2);
            if($fileName = $_FILES['file']['error'] > 0){
                ...
                if ($CSVfp !== FALSE) {
                    ...
                    if(isset($_POST['empty']) && $_POST['empty'] == "delete"){
                        $stmt2 = $conn->prepare("DELETE FROM items
                                                ...
                                                WHERE orders_contents.itemID = items.itemID)");
                        $stmt2->execute();
                            ...
                            if($row > 0){
                                ...
                                if(!$e){
                                    ...
                                    if(isset($data[$expDate])){
                                        ...
                                        $oldExpDate = $item->getItemPropWhere('expDate1', ["=", ">="], ['itemName', 'visibility']);
            ...
            if(isset($_POST['itemName'], $_POST['itemID']) && !empty($_POST['itemName']) && strlen($_POST['itemName']) > 3 && strlen($_POST['itemName']) < 200
                ...
                $visibility = (isset($_POST['visibility']) && in_array($_POST['visibility'], [-1, 0, 1])) ? $_POST['visibility'] : fnc::redirectHome('خطأ: 6735', 'back', 2);
                ...
                if(!$e){
                    fnc::redirectHome("خطأ: 7742", 'back', 2);
                }
            ...
            /** operations area */
            if($op == 'delete'){
                if($item->checkItem($err, 'orders_contents' , "AND", 'itemID') > 0){ /* make sure that item doesn't exist in any order */
                    $errorMsg = langTXT("SYS CAN DEL") ;
                    fnc::redirectHome($errorMsg, './', 2);
                }else{
                    if($item->deleteItem($err, 'itemID')){
                        $successMsg = langTXT("ITE HAS DEL");
                        fnc::redirectHome($successMsg, './', 2, 'success');
                    }else{
                ...
                if($item->updateItem($err, 'itemID', 'visibility', $lastBy, $lastDate)){
                    ...
                    fnc::redirectHome($successMsg, 'back', 2, 'success');
                }else{
                            ...
                            <table class="main-table more-info table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><b><?php echo $item->payPrice. " ". lang("L.D")?></b></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo lang("AVR PUR PRI")?></td>
                                        <td><b><?php echo $item->avrPayPrice. " ". lang("L.D") ?></b></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo lang("SAL PRI")?></td>
                                        <td><b><?php echo $item->salePrice. " ". lang("L.D") ?></b></td>
                                    </tr>
                                    <tr>
