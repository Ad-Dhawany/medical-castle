...
class broadNotifications{
    ...
    public $referenceID ;
    public $createdDate ;
    const TABLE_NAME = "broad_notifications";
    function __construct(&$isSuccess = 0, $noteID=null, $launcherID=null,
                        $recipients =null, $type=null, $importance=null, $referenceID=null)
                {
                    ...
                    $this->recipients       = (isset($recipients) && is_numeric(trim($recipients))) ? intval(trim($recipients)) : null ;
                    ...
                    if((isset($noteID) && !isset($this->noteID)) || (isset($launcherID ) && !isset($this->launcherID ))
                        || (isset($recipients ) && !isset($this->recipients )) || (isset($type) && !isset($this->type))
    ...
    /** */
    function markAsRead(){
        $reader = new broadNotificationsReaders($is, null, $this->noteID, $_SESSION['userID']);
        return $reader->insertNotificationReader($err, 'noteID', 'readerID');
    }
    /*************************/
}